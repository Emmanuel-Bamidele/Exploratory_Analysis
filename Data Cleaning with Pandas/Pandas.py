...
# Get the structure of the dat
print("\n The dataset shape is: ", df.shape) #shape of our data
...
print("\n The number of palladium data is: ", df_palladium.shape)
print("\n")
...
print("\n The number of nickel data is: ", df_nickel.shape)
print("\n")
...
print("\n The number of brent oil data is: ", df_brentoil.shape)
print("\n")
...
print("\n The number of natural gas data is: ", df_natural_gas.shape)
print("\n")
print(df_natural_gas.head())

#assign all keywords with gold to df_gold and read only columns with gold (top five)
df_wheat = df.loc[df['Symbol'] == 'Wheat']
print("\n The number of wheat data is: ", df_wheat.shape)
print("\n")
print(df_wheat.head())
...
print("\n The first entry of each group in the Symbol column by date are: ")
...
print("\n The number of data with either gold or nickel is: ", df_gold_nickel.shape)
print("\n")
...
print("\n This will show an index column with the renumbered index without old index")
print("\n")
print(df_gold_nickel.tail())

#Leave old index
df_gold_nickel2 = df_gold_nickel.reset_index(drop=False)
print("\n This will show an index column with the renumbered index and old index")
print("\n")
print(df_gold_nickel2.tail())

#Set new index
df_gold_nickel.index = df_gold_nickel.index
print("\n This will set the index column to index")
print("\n")
print(df_gold_nickel.tail())
